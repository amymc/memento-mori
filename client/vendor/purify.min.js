...
!(function (e, t) {
  ...
  var ne = (function t() {
    ...
    const pt = r.createElement("form"),
      ...
      dt = function () {
        ...
        if (!mt || mt !== e) {
          if (
            ...
            (e = w(e)),
            (ct =
              -1 === st.indexOf(e.PARSER_MEDIA_TYPE)
                ? "text/html"
                : e.PARSER_MEDIA_TYPE),
            (ut = "application/xhtml+xml" === ct ? d : f),
            (Ne = E(e, "ALLOWED_TAGS") ? S({}, e.ALLOWED_TAGS, ut) : be),
            (Se = E(e, "ALLOWED_ATTR") ? S({}, e.ALLOWED_ATTR, ut) : Re),
            (ot = E(e, "ALLOWED_NAMESPACES")
              ? S({}, e.ALLOWED_NAMESPACES, d)
              : rt),
            (Ve = E(e, "ADD_URI_SAFE_ATTR")
              ? S(w(Ze), e.ADD_URI_SAFE_ATTR, ut)
              : Ze),
            ($e = E(e, "ADD_DATA_URI_TAGS")
              ? S(w(Ke), e.ADD_DATA_URI_TAGS, ut)
              : Ke),
            (Xe = E(e, "FORBID_CONTENTS") ? S({}, e.FORBID_CONTENTS, ut) : qe),
            (Le = E(e, "FORBID_TAGS") ? S({}, e.FORBID_TAGS, ut) : {}),
            (Ce = E(e, "FORBID_ATTR") ? S({}, e.FORBID_ATTR, ut) : {}),
            (je = !!E(e, "USE_PROFILES") && e.USE_PROFILES),
            (Oe = !1 !== e.ALLOW_ARIA_ATTR),
            ...
            (tt = e.NAMESPACE || et),
            (it = e.MATHML_TEXT_INTEGRATION_POINTS || it),
            (at = e.HTML_INTEGRATION_POINTS || at),
            (we = e.CUSTOM_ELEMENT_HANDLING || {}),
            e.CUSTOM_ELEMENT_HANDLING &&
              ft(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
              (we.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
            e.CUSTOM_ELEMENT_HANDLING &&
              ft(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
            ...
            je &&
              ((Ne = S({}, I)),
              (Se = []),
              !0 === je.html && (S(Ne, C), S(Se, M)),
              !0 === je.svg && (S(Ne, O), S(Se, U), S(Se, H)),
              !0 === je.svgFilters && (S(Ne, v), S(Se, U), S(Se, H)),
              !0 === je.mathMl && (S(Ne, x), S(Se, P), S(Se, H))),
            e.ADD_TAGS && (Ne === be && (Ne = w(Ne)), S(Ne, e.ADD_TAGS, ut)),
            e.ADD_ATTR && (Se === Re && (Se = w(Se)), S(Se, e.ADD_ATTR, ut)),
            e.ADD_URI_SAFE_ATTR && S(Ve, e.ADD_URI_SAFE_ATTR, ut),
            e.FORBID_CONTENTS &&
              (Xe === qe && (Xe = w(Xe)), S(Xe, e.FORBID_CONTENTS, ut)),
            Ge && (Ne["#text"] = !0),
            Me && S(Ne, ["html", "head", "body"]),
            Ne.table && (S(Ne, ["tbody"]), delete Le.tbody),
      ...
      Rt = function (e, t, n) {
        if (Be && ("id" === t || "name" === t) && (n in r || n in pt))
          return !1;
        if (ve && !Ce[t] && _(ge, t));
        else if (Oe && _(Te, t));
        else if (!Se[t] || Ce[t]) {
      ...
      Ct = function e(t) {
        ...
        for (bt("beforeSanitizeShadowDOM", t, null); (n = o.nextNode()); )
          bt("uponSanitizeShadowNode", n, null),
            St(n) || (n.content instanceof s && e(n.content), Lt(n));
    ...
    return (
      (o.sanitize = function (e) {
        ...
        if (
          (Ue || dt(t), (o.removed = []), "string" == typeof e && (Ye = !1), Ye)
        ) {
          if (e.nodeName) {
        ...
        const c = _t(Ye ? e : n);
        for (; (i = c.nextNode()); )
          St(i) || (i.content instanceof s && Ct(i.content), Lt(i));
        if (Ye) return e;
        if (He) {
          if (Fe)
